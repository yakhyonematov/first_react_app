      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            >
              {t("asosiy.buttons.kitoblar")} <BookOpen size={20} />
            </Link>
            <Link
              to="/users"
            ...
            >
              {t("asosiy.buttons.foydalanuvchilar")} <Users size={20} />
            </Link>
          </div>
        </div>
        ...
        <div className="mt-20 grid grid-cols-1 gap-8 sm:grid-cols-3 lg:mt-32">
          <div className="flex flex-col gap-y-4 rounded-3xl bg-gray-800/50 p-8 border border-gray-700 backdrop-blur-sm">
            ...
            <h3 className="text-xl font-bold text-white">{t("asosiy.cards.card1.h2")}</h3>
            <p className="text-gray-400">{t("asosiy.cards.card1.p")}</p>
          </div>
          <div className="flex flex-col gap-y-4 rounded-3xl bg-gray-800/50 p-8 border border-gray-700 backdrop-blur-sm">
            <div className="h-12 w-12 rounded-xl bg-blue-400/10 flex items-center justify-center text-blue-400">
              <Users />
            </div>
            <h3 className="text-xl font-bold text-white">{t("asosiy.cards.card2.h2")}</h3>
            <p className="text-gray-400">{t("asosiy.cards.card2.p")}</p>
          </div>
          <div className="flex flex-col gap-y-4 rounded-3xl bg-gray-800/50 p-8 border border-gray-700 backdrop-blur-sm">
            <div className="h-12 w-12 rounded-xl bg-green-400/10 flex items-center justify-center text-green-400">
              <ArrowRight />
            </div>
            <h3 className="text-xl font-bold text-white">{t("asosiy.cards.card3.h2")}</h3>
            <p className="text-gray-400">{t("asosiy.cards.card3.p")}</p>
          </div>
        </div>
      </div>
    </div>
